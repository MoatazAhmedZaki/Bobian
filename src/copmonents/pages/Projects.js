    ...
    this.state = {
      ...
      local: [
        ...
        },
        {
          ...
          name: 'Al Safwa Complex',
          alt: 'Al Safwa Complex'
        },
        {
          srcwebp:
      ...
      international: [
        ...
        },
        {
          ...
          name: 'Switzerland Novartis Pharma',
          alt: 'Switzerland Novartis Pharma '
        },
        {
          ...
          <Slider {...settings} className="mb-5">
            {this.state.local.map(function(local) {
              return (
                ...
                className="img-fluid kuwitimg"  alt={local.alt}
                type="image/webp"
              />
                      <source
                        srcSet={local.srcpng}
            ...
            {this.state.international.map(function(inter) {
              return (
                ...
                srcSet={inter.srcwebp}
                   className="img-fluid interimg" alt={inter.alt}
                type="image/webp"
              />
                      <source
                        srcSet={inter.srcpng}
